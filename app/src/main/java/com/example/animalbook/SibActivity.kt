...
import com.example.animalbook.databinding.ActivitySibBinding

class SibActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySibBinding
    private lateinit var title: TitleFragment
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySibBinding.inflate(layoutInflater)
